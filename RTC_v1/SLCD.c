...
void initSLCD(void){ //Initializes all components of SLCD on the FRDM-KL46Z
	...
	LCD->AR = //LCD_AR_BLINK_MASK |							//Clear LCD_SEG_AR_BLINK, Disable SLCD blinking.  Enable to make LCD Blink.
						...
						LCD_AR_BRATE(0x02);								//Set LCD_SEG_AR_BRATE to 000.  Frequency of blink is determined by LCD clock/(2^(12 + BRATE))
...
//SegLCD_Off() defined as macro in Seg_LCD.h, Turns off rightmost decimal without disturbing rest of display
